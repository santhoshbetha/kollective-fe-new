            ...
            <div className="p-6 flex flex-col justify-between flex-1">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-[#262626]/50">
                    ...
                    <button 
                        ...
                        className={`hover:bg-red-700 text-white text-xs font-bold px-6 py-2.5 rounded-[8px] transition-colors uppercase tracking-widest border-none cursor-pointer ${
                            event.isInterested ? 'bg-zinc-800 hover:bg-zinc-700' : 'bg-[#cc0000]'
                        }`}
                    >
