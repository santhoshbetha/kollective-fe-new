            ...
            <main className="max-w-[1000px] mx-auto px-6 mt-8 animate-in fade-in duration-300">
                <div className="glass-panel border border-white/5 bg-[var(--surface-container)]/40 rounded-3xl p-6 sm:p-10 shadow-2xl backdrop-blur-md">
                    <div className="flex items-center gap-4 mb-6 pb-6 border-b border-white/5">
                        ...
                        <div>
                            <h1 className="text-2xl sm:text-3xl font-black dark:text-white tracking-tight">Terms of Service</h1>
                    ...
                    <div className="prose prose-invert max-w-none text-lg text-text-secondary/90 leading-relaxed space-y-6">
                        ...
                        <h2 className="text-lg font-bold dark:text-white uppercase tracking-wider pt-4 border-b border-white/5 pb-2">1. Acceptance of Terms</h2>
                        <p>
                        ...
                        <h2 className="text-lg font-bold dark:text-white uppercase tracking-wider pt-4 border-b border-white/5 pb-2">2. Use of Services</h2>
                        <p>
                        ...
                        <h2 className="text-lg font-bold dark:text-white uppercase tracking-wider pt-4 border-b border-white/5 pb-2">3. Content & Trust Framework</h2>
                        <p>
                        ...
                        <h2 className="text-lg font-bold dark:text-white uppercase tracking-wider pt-4 border-b border-white/5 pb-2">4. Disclaimers & Liability</h2>
                        <p>
