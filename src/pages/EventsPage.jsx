        ...
        <div className="flex items-center gap-4">
          ...
          <div className="bg-[#141414] p-1 rounded-[8px] flex border border-[#262626]" data-purpose="view-switcher">
            <button
              ...
              className={`px-4 py-1.5 text-xs font-bold rounded-[8px] flex items-center gap-2 border-none cursor-pointer ${viewMode === 'grid' ? 'bg-[#cc0000] text-white' : 'text-gray-500 hover:text-white bg-transparent'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 text-xs font-bold rounded-[8px] flex items-center gap-2 border-none cursor-pointer ${viewMode === 'calendar' ? 'bg-[#cc0000] text-white' : 'text-gray-500 hover:text-white bg-transparent'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 text-xs font-bold rounded-[8px] flex items-center gap-2 border-none cursor-pointer ${viewMode === 'map' ? 'bg-[#cc0000] text-white' : 'text-gray-500 hover:text-white bg-transparent'
                }`}
            >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-[#cc0000] hover:bg-red-700 text-white rounded-[8px] font-bold transition-all active:scale-95 text-xs uppercase tracking-widest cursor-pointer border-none"
          >
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-zinc-900 rounded-[8px] flex items-center justify-center border border-zinc-800">
              <span className="material-symbols-outlined text-[#cc0000] text-xl">filter_list</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2 flex flex-col">
              ...
              <div className="relative">
                <input
                  className="w-full bg-[#0a0a0a] border border-[#262626] focus:border-[#cc0000] focus:ring-1 focus:ring-[#cc0000] text-sm rounded-[8px] pl-10 py-3 text-white placeholder:text-gray-600 outline-none"
        ...
        <>
          {eventsLoading ? (
            <div className="py-12 flex flex-col items-center gap-4">
              <div className="w-8 h-8 rounded-full border-2 border-t-[#cc0000] border-white/10 animate-spin"></div>
          ...
          {filteredEvents && filteredEvents.length > 0 && (
            <div className="mt-16 flex justify-center">
              <button
                ...
                className="flex items-center gap-3 px-8 py-4 border border-[#262626] rounded-[8px] text-sm font-bold text-[#A19B95] hover:text-white hover:border-[#cc0000] transition-all cursor-pointer bg-transparent"
              >
          ...
          <div className="px-8 py-6 border-b border-white/5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full border border-white/10 hover:border-[#cc0000]/50 hover:bg-[#cc0000]/10 transition-all group bg-transparent cursor-pointer"
              >
                <span className="material-symbols-outlined text-text-secondary group-hover:text-[#cc0000]">chevron_right</span>
              </button>
            </div>
          </div>
