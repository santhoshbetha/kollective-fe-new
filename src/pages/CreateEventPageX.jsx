                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="custom-date-input w-full bg-surface-container-low border border-white/5 rounded-xl px-4 py-3 text-text-primary focus:border-primary-container focus:ring-4 focus:ring-primary-container/10 transition-all outline-none text-lg md:text-sm"
                    />
                  </div>
                  <div className="space-y-1.5">
