...
export function CascadedPostRowX2({
    post: propPost,
    isFocus,
    isAncestor,
    depth = 0,
    ...
    return (
        <div
            ...
            className={`flex flex-col relative p-6 border-b border-[#262626] last:border-b-0 transition-all duration-300 ${isFocus ? 'bg-[#181818]' : 'bg-[#141414] hover:bg-white/[0.015] cursor-pointer'
        ...
        >
            ...
            <div className="flex gap-4 z-10 relative">
                <div className="w-12 h-12 rounded-xl overflow-hidden border border-white/10 shrink-0 bg-[#1A1616]" hidden>
                    {post?.author?.avatar ? (
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1.5 gap-2">
                        <div className="flex flex-col items-center gap-1.5 min-w-0">
                            ...
                            <span className="text-[14px] text-text-secondary font-mono truncate">
                                {authorHandle}
                            </span>
                        </div>
                    ...
                    <div className="pt-4 flex items-center gap-8 text-text-secondary">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isSelf
                                    ...
                                    : isAlreadyReblogged
                                        ? "text-emerald-500 font-extrabold cursor-default opacity-90"
                                        : "text-text-secondary hover:text-emerald-500 cursor-pointer"
                            )}
                        >
                            <span
                            ...
                            <span>{(reblogsCount || 0).toLocaleString()}</span>
                        </button>
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1.5 text-sm transition-colors bg-transparent border-none ml-auto ${isSelf ? 'opacity-40 cursor-not-allowed text-text-secondary/50' : post?.bookmarked ? 'text-amber-500 cursor-pointer' : 'hover:text-amber-500 cursor-pointer'}`}
                        >
                            <span
